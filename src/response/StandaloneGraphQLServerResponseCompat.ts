 ...
 * Compat implementation does not implement setHeader() and end() methods to test their fallbacks header() and send().
 */
export class StandaloneGraphQLServerResponseCompat
    implements GraphQLServerResponse
{
    statusCode = 400
